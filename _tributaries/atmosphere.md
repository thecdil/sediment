...
{% include feature/image-gallery.html objectid="sediment129; sediment132" caption=false%}
...
{% include feature/image-gallery.html objectid="sediment103; sediment115" caption=false%}
...
Silt deposits form ‘mud volcanoes’ which emit methane into the atmosphere. Globally, 2-3% of greenhouse gas emissions are caused by reservoirs undergoing similar methane entrapment and release processes. 
...
{% comment %}
This is where collection objects related to atmosphere will be displayed
{% endcomment %}

*More content about atmospheric sediment transport will be added here.*